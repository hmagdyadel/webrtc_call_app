...
class _Loaded implements ContactsState {
...
@override
String toString() {
  return 'ContactsState.loaded(users: $users)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ContactsStateCopyWith<$Res> {
